...
def train_yolo(annotation_path, log_dir, classes_path, anchors_path, input_shape, output_path):
...
if __name__ == '__main__':
    train_yolo(annotation_path='train.txt', log_dir='logs/000/', classes_path='model_data/voc_classes.txt',
