import os
import cv2
from mean_average_precision import Evaluator
...
class Classifier(object):
    ...
    def prepare_training_set(self, path2data, size):
        """
    ...
    def generate_training_annotation(self, path2data, annotation_file, classes_file, berkley_path):
        """
    ...
    def train_yolo_classifier(self, train_annotation_file, log_dir, classes_file, anchors_file, output_network_path, size):
        """
        ...
        yolo_trainer.train_yolo(annotation_path=train_annotation_file,
    ...
    def accuracy_yolo(self, eval_path):
        """
        ...
        """
        eval_obj = Evaluator()
        acc = eval_obj.run_evaluation_map(path_to_eval_data=eval_path)
        try:
            return acc["mAP"]
        except KeyError:
            return None
    ...
    def yolo_detect(self, path2images, model_path, anchors_path, classes_path, size, predicted_path):
        """
