...
class YOLOTrainer(object):
    ...
    def train_yolo(self, annotation_path, log_dir, classes_path, anchors_path, input_shape, output_path):
        ...
        if True:
            ...
            model.fit_generator(self.data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
                                steps_per_epoch=max(1, num_train//batch_size),
                                validation_data=self.data_generator_wrapper(lines[num_train:], batch_size,
...
if __name__ == '__main__':
    trainer = YOLOTrainer()
    trainer.train_yolo(annotation_path='train.txt', log_dir='logs/000/', classes_path='model_data/voc_classes.txt',
               anchors_path='model_data/yolo_anchors.txt', input_shape=(416, 416),
               output_path='logs/000/trained_weights_final.h5')
