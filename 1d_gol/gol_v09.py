...
class GOL(object):
    ...
    def train(self, num_epochs=100):
        with open('evaluation.csv', 'w', newline='') as f:
            ...
            epoch_count = 0
            # writer.writerow(('epoch', 'accuracy', 'no_templates', 'losses'))
            ...
            for epoch in range(num_epochs):
                ...
                writer.writerow((epoch_count, self.classifier.accuracy, self.template_objects.num_objects, str_losses))

                #self._plot_distributions(epoch_count)
                epoch_count += 1
    ...
    def train_generator(self):
        ...
        self.generalization_generator.generalization_functions(self.losses)
