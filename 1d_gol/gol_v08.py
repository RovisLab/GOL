...
class GeneralizationGenerator(object):
    ...
    def generalization_functions(self, losses):
        self.sigmas += 0.3
...
class GOL(object):
    ...
    def train_generator(self, num_epochs=1):
        ...
        for i in range(num_epochs):
            ...
            self.generalization_generator.generalization_functions(losses)
...
def main():
    ...
    gg = GeneralizationGenerator(to, rs, num_objects=to.num_objects, num_gen_samples_per_object=10)
