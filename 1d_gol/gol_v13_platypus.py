...
class GOL(Problem):
    ...
    def train_generator(self):
        print("Generalization Generator Training")
    ...
    def _plot_distributions(self, epoch_count):
        ...
        # Draw the energies
        #print(self.generalization_energy)
...
def main():
    ...
    gg = GeneralizationGenerator(os, rs, num_objects=os.num_objects, num_gen_samples_per_object=1000)
